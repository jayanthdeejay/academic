...
#include <sys/time.h>
#endif
#include "/usr/local/cuda-5.5/include/thrust/random/linear_congruential_engine.h"
#include "/usr/local/cuda-5.5/include/thrust/random/normal_distribution.h"
#include "/usr/local/cuda-5.5/include/thrust/random/uniform_int_distribution.h"
